...
const Login = () => {
  ...
  return (
    <div style={{ height: "100vh",backgroundImage: "url('/bg11_new.png')",backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center"}}>
      {/* Main Container */}
      <div className="container">
        ...
        {/* Login Card */}
        <div className="d-flex justify-content-around align-items-center shadow-lg p-8 rounded bg-[#f3f3f3]" style={{height:"450px"}}>
          ...
          <div className="text-center lg:text-left lg:w-1/3 mb-6 lg:mb-0">
            ...
            <div>
              <h5 className="text-uppercase fw-bold text-[#005D7F] mb-3">Bridge Management Systems</h5>
              <p className="fs-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. A, aliquid autem deserunt earum eligendi in ipsa itaque minus nesciunt officia perspiciatis quos reiciendis repellendus sunt suscipit tempore unde voluptate voluptates!</p>
              <p className="mt-5 fs-6">Designed and Developed by <a href="" className="text-[#005D7F]">The Urban Unit</a></p>
            </div>
          ...
          <div className="lg:w-1/3">
            <div className="text-center lg:text-left mb-4">
              <h4 className="text-xl font-bold text-gray-700">Dashboard Login</h4>
