...
const InventoryInfo = ({ inventoryData }) => {
  ...
  const spanIndexes = Array.from({ length: spanCount }, (_, index) => index + 1);
  ...
  return (
    <div className="container d-flex justify-content-center align-items-center min-vh-100">
      <div
        className="card p-4 rounded-lg text-black"
        style={{
          background: "#FFFFFF",
      ...
      >
        <div className="card-body pb-0">
          <h5 className="card-title text-lg font-semibold pb-3">Inventory Info</h5>
          <Form>
            <Row>
              {[
                ...
                if (field.includes(",")) {
                  ...
                  value = fields.map((f) => inventoryData[f.trim()] || "").join(", ");
                } else {
                  value = inventoryData ? inventoryData[field] || "" : "";
                }

                // Display three fields per row, adjusted width
                return (
                  <Col key={index} md={6} lg={4}>
                    <Form.Group controlId={`form${field}`}>
                      ...
                      <Form.Control
                        ...
                        value={value}
                        readOnly
                        style={{ padding: "12px", fontSize: "16px" }} // Added padding and font size adjustments
                      />
                    </Form.Group>
                  </Col>
                );
                ...
                <Col md={8}>
                  <Form.Group controlId="formSpanPhotos">
                    <div className="d-flex flex-wrap">
                      {spanphotos[selectedSpan] && spanphotos[selectedSpan].length > 0 ? (
