...
import UnapprovedInspectionsModal from "./UnapprovedInspectionsRamsModal";
import Papa from "papaparse";
import { FaFileCsv} from "react-icons/fa6";

const UnapprovedInspections = ({ districtId, bridgeName, structureType, api_endpoint }) => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const url = new URL(`${BASE_URL}/api/${api_endpoint}`);
