...
const Graph = () => {
  ...
  const materialElementDamagesOptions = {
    ...
    xAxis: {
      categories: [
        'Superstructure - Steel', 'Concrete', 'Other',
        'Substructure(Pier) - Steel', 'Concrete', 'Other',
        'Masonry/brick', 'Substructure(Abutment) - Steel',
        'Concrete', 'Other', 'Masonry/brick',
        'Substructure(Foundation) - Concrete', 'Other',
        'Bearing - Steel', 'Concrete', 'Other', 'Rubber',
        'Road surface - Steel', 'Concrete', 'Rubber', 'Asphalt',
        'Other', 'Drainage system - Steel', 'Vinyl chloride',
        'Other', 'Attachment - Steel', 'Vinyl chloride',
        'Other', 'Wing wall - Concrete', 'Other',
        'Box Culvert - Other'
      ],
      title: {
        text: 'Elements'
    ...
    series: [{
      ...
      data: [100, 1800, 200, 300, 400, 150, 400, 200, 100, 100, 400, 50, 50, 20, 30, 20, 10, 200, 800, 100, 400, 200, 10, 10, 400, 50, 10, 20, 100, 800, 100],
      color: '#0000FF'
    }, {
      name: 'Number of Damages II',
      data: [50, 1200, 100, 200, 600, 100, 600, 150, 50, 50, 500, 30, 30, 10, 20, 10, 5, 150, 1000, 50, 500, 300, 5, 5, 600, 30, 5, 10, 50, 600, 50],
      color: '#FFA500'
    }, {
      name: 'Number of Damages III',
      data: [30, 200, 50, 100, 100, 50, 100, 50, 30, 30, 100, 20, 20, 5, 10, 5, 3, 100, 200, 30, 100, 100, 3, 3, 200, 20, 3, 5, 30, 200, 30],
      color: '#808080'
    }, {
      name: 'Number of Damages IV',
      data: [20, 100, 30, 50, 50, 30, 50, 30, 20, 20, 50, 10, 10, 3, 5, 3, 2, 50, 100, 20, 50, 50, 2, 2, 100, 10, 2, 3, 20, 100, 20],
      color: '#FFFF00'
    }]
  };
  ...
  const elementCategoryDamagesOptions = {
    ...
    xAxis: {
      categories: [
        'Superstructure', 'Substructure(Pier)', 'Substructure(Abutment)',
        'Substructure(Foundation)', 'Bearing', 'Road surface',
        'Drainage system', 'Attachment', 'Wing wall', 'Box Culvert'
      ],
      title: {
        text: 'Work Kind'
      }
